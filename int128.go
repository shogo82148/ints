...
func (a Int128) Text(base int) string {
	_, s := formatUint128(nil, a[0], a[1], base, int64(a[0]) < 0, false)
	return s
}
...
func (a Int128) Append(dst []byte, base int) []byte {
	d, _ := formatUint128(dst, a[0], a[1], base, int64(a[0]) < 0, true)
	return d
}

// AppendText implements the [encoding.TextAppender] interface.
func (a Int128) AppendText(dst []byte) ([]byte, error) {
	d, _ := formatUint128(dst, a[0], a[1], 10, int64(a[0]) < 0, true)
	return d, nil
}

// String returns the string representation of a in base 10.
func (a Int128) String() string {
	_, s := formatUint128(nil, a[0], a[1], 10, int64(a[0]) < 0, false)
	return s
}
